program cis_olap_test
    ...
    do while (i < narg)
        ...
        case('--help')
            ...
            write(stdout, '(25x,a,l)') 'default: ', center2
    ...
    open(newunit=ounit, file=outfile, action='write')
    do i = 0, nwf2
        write(ounit, '(1000es24.16)') s_wf(i, :)
    end do
    close(ounit)
